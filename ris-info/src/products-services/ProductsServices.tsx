...
function ProductsServices() {
  ...
  return (
    <>
      ...
      {/* ここにコンテンツを追加 */}
      <a href="https://github.com/deidra-JP-windows?tab=repositories&q=ris&type=&language=&sort=" target="_blank" rel="noopener noreferrer">
        <h2 className="common_animated_text">
          {"GitHub Repositories".split("").map((char, i) => (
            <span key={i} style={{
              display: 'inline-block',
              opacity: 0,
              animation: `fadeInLeft 0.4s forwards`,
